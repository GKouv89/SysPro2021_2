...
ΠΡΩΤΟΚΟΛΛΟ ΕΠΙΚΟΙΝΩΝΙΑΣ
    ...
    3) Εντολές
        ...
        3.3) /addVaccinationRecords.
            ...
            για το SIGUSR1 σήμα, αν το βρει set ενημερώνει τον γονιό ότι περιμένει να λάβει το όνομα της χώρας στον φάκελο της οποίας προστέθηκαν νέα αρχεία (δηλαδή,
            το όρισμα country που δίνουμε στον γονιό). O γονιός μπλοκάρει μέχρις ότου έρθουν τα νέα bloom filters, ακριβώς με τον ίδιο τρόπο που περιγράφεται στο 2.2, 
...
ΔΙΑΧΕΙΡΙΣΗ ΣΗΜΑΤΩΝ
    ...
    Λήψη Σήματος SIGINT/SIGQUIT από το Monitor process
        ...
        ερωτήματος. Αυτό ισχύει και για το σήμα SIGCHLD που θα λάβει ο γονιός για να αντικαταστήσει το παιδί που έλαβε το SIGINT/SIGQUIT: θεωρούμε ότι έχει
